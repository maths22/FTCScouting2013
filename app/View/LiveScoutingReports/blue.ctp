...
<?php echo $this->Form->create('LiveScoutingReport'); ?>
	<fieldset>
		<legend><?php echo __('Add Live Scouting Report'); ?><br/>Blue Alliance</legend>
	<?php
		echo $this->Form->hidden('user_id',array('value'=>'2'));
                echo $this->Form->input('match_id',array('type'=>'text','value'=>$match));
                echo '<div id="team_1">';
		echo $this->Form->input('team_id_1',array('type'=>'text','value'=>$blueTeam1,'label' => 'Blue Team 1'));
		...
		echo $this->Form->textarea('generalComments_1',array('rows'=>'5'));
                echo '</div>';
                echo '<div id="team_2">';
		echo $this->Form->input('team_id_2',array('type'=>'text','value'=>$blueTeam2,'label' => 'Blue Team 2'));
